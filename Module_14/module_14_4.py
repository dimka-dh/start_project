...
#Добавление данных в таблицу через однократный запуск файла crud_functions
initiate_db()
...
async def get_buying_list(message: types.Message):
    ...
    for product in products:
        await message.answer_photo(
            photo=f"https://nhatrangshop.ru/wa-data/public/shop/products/85/34/3485/images/3202/Zvezdochka---lyubaya-gramovka.970.jpeg?text={product[1]}",
